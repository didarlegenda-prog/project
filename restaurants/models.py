...
class Restaurant(models.Model):
    ...
    cuisine_type = models.JSONField(default=list)  # e.g., ["Italian", "Pizza"]
    ...
    # Business hours
    business_hours = models.JSONField(default=dict)  # e.g., {"monday": {"open": "09:00", "close": "22:00"}}
    ...
    # Features
    features = models.JSONField(default=list)  # e.g., ["Delivery", "Takeout", "Dine-in", "WiFi"]
...
class RestaurantImage(models.Model):
    """Additional images for restaurant."""
...
class Table(models.Model):
    """Restaurant table model for reservations."""
    
    restaurant = models.ForeignKey(Restaurant, on_delete=models.CASCADE, related_name='tables')
    table_number = models.CharField(max_length=20)
    capacity = models.IntegerField(validators=[MinValueValidator(1)])
    is_available = models.BooleanField(default=True)
    location = models.CharField(max_length=50, blank=True)  # e.g., "Window", "Patio", "Indoor"
